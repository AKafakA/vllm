...
accuracy the oracle can achieve at moderate rates. A representative
profile (Qwen3-8B on RTX~8000, filtered ShareGPT) is
$1.8$\,MB of JSON containing ${\approx}143$K step-cycle samples
across ${\approx}7.2$K buckets, captured in ${\approx}2.4$ hours of
GPU wall-clock time.
