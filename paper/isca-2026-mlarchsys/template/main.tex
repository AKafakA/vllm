...
open-source release of \sysname{} is 2.9K lines of Python
split across four parts: oracle (density-aware step-latency,
828~lines), vLLM integration (platform plugin, executor
hook, GPU cost path, and mocks; 1048~lines), profile
