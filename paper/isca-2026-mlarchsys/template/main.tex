...
M1b/M2/M4 are main; R3 is the prefix-cache-OFF ablation.}
\label{tab:main}
\small
...
tuned constants --- and accurate across three cells, a
prefix-cache-OFF ablation, and the full $r\in\{2,4,8,16,32\}$
sweep, conditional on two reproducibility invariants stated
in \S\ref{sec:design}. Open-sourcing the plugin, long-context
